...
const App: React.FC = () => {
  ...
  const [passcodeContext, setPasscodeContext] = useState<{ 
    action: 'clear' | 'deleteTab' | 'addRecord' | 'editRecord' | 'deleteRecord' | 'adjustQty' | 'toggleRestriction' | 'openUsers' | 'push' | 'pull' | 'setupPersonalCloud' | 'deleteCycle' | 'deleteInvestor' | 'deleteSignature'; 
    targetTab?: string;
    data?: any;
