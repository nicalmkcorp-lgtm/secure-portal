...
const InvestorModal: React.FC<InvestorModalProps> = ({ isOpen, onClose, investors, onAddInvestor, onUpdateInvestor, onDeleteInvestor, onDeleteSignature, currencyConfig, scriptUrl, githubPagesUrl, showToast, authorizedSignature, fundHolderName }) => {
